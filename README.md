...
proton-native-cli/0.0.2 linux-x64 node-v10.18.0
...
_See code: [src/commands/init.ts](https://github.com/kusti8/proton-native-cli/blob/v0.0.2/src/commands/init.ts)_
<!-- commandsstop -->
